...
$VM_ROOT/control/$VM_NAME/exec.sh "mkdir $TARGET_TEMP_DIR; rm -rf /tmp/*"
...
$VM_ROOT/control/$VM_NAME/exec.sh "cd $TARGET_TEMP_DIR/$PROJECT_NAME; make -f Makefile.ult; ./scripts/check.sh"
